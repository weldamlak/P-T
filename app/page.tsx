      ...
      >
          ...
          <div className="max-w-6xl w-full mx-auto space-y-8 sm:space-y-12">
            <div className="space-y-2">
              <span
                className={`text-xs sm:text-sm font-mono font-bold tracking-widest uppercase ${
                  darkMode ? "text-emerald-400" : "text-sky-600"
                }`}
              >
                MY JOURNEY
              </span>
              <h2
                className={`text-2xl sm:text-4xl font-extrabold uppercase tracking-wider ${
            ...
            <div className="space-y-4 sm:space-y-6">
              {EXPERIENCES.map((exp, idx) => (
                <div
                  key={idx}
                  className={`p-6 sm:p-8 rounded-2xl border shadow-sm transition-all duration-300 hover:-translate-y-1 ${
                    darkMode
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="space-y-3 flex-1">
                      <div
                        className={`flex flex-wrap items-center gap-2 text-xs font-mono font-bold ${
                          darkMode ? "text-emerald-400" : "text-sky-600"
                        }`}
                      >
                        <span className="text-sm font-extrabold">{exp.company}</span>
                        <span className={darkMode ? "text-slate-600" : "text-slate-300"}>•</span>
                        <span className={darkMode ? "text-slate-400" : "text-slate-500"}>{exp.period}</span>
                      </div>

                      <h3 className={`font-black text-lg sm:text-xl ${darkMode ? "text-slate-100" : "text-slate-950"}`}>
                        {exp.role}
                      </h3>

                      <p className={`text-sm sm:text-base leading-relaxed ${darkMode ? "text-slate-300" : "text-slate-700 font-medium"}`}>
                        {exp.description}
                      </p>
                    </div>
                    ...
                    {exp.logo && exp.link && (
                      <a
                        ...
                        className={`shrink-0 p-2 rounded-2xl border flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 group shadow-md ${
                          darkMode
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {PROJECTS_LIST.map((project) => {
                ...
                return (
                  <div
                    key={project.id}
                    className={`p-6 sm:p-8 rounded-2xl border shadow-sm flex flex-col justify-between space-y-6 transition-all duration-300 hover:-translate-y-1 ${
                      darkMode
                        ? "bg-slate-900/60 border-slate-800 hover:border-emerald-500/40"
                        : "bg-white border-slate-200 hover:border-sky-300"
                    }`}
                  >
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <span className={`text-2xl font-mono font-black ${darkMode ? "text-slate-600" : "text-slate-300"}`}>
                          {project.id}
                        </span>
                        <div
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.tags.map((tag, tagIdx) => (
                          <span
                            key={tagIdx}
                            className={`px-2.5 py-0.5 rounded-md text-xs font-mono font-bold uppercase tracking-wider ${
                              darkMode
                    ...
                    <div className="flex items-center space-x-3 pt-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className={`inline-flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider border transition-all active:scale-95 ${
                          darkMode
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className={`inline-flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all active:scale-95 text-white shadow-md ${
                          darkMode
        ...
        >
          <div className="max-w-6xl w-full mx-auto space-y-8 sm:space-y-12">
            ...
            <div
              className={`p-6 sm:p-8 rounded-2xl border shadow-sm relative overflow-hidden transition-all ${
                darkMode
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-xs font-mono text-slate-400 font-semibold">EAII</span>
                  </div>
                  <h3 className="text-lg sm:text-xl font-bold">
                    Student Intern at Ethiopian Artificial Intelligence Institute (EAII)
                  </h3>
                  <p className={`text-sm leading-relaxed max-w-2xl ${darkMode ? "text-slate-400" : "text-slate-600"}`}>
                ...
                <a
                  ...
                  className={`shrink-0 p-2.5 rounded-2xl border flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 group ${
                    darkMode
                      ? "bg-slate-950 border-slate-800 hover:border-emerald-500/50 shadow-emerald-500/10"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {SKILLS_LIST.map((skill, idx) => (
                <div
                  key={idx}
                  className={`p-6 rounded-2xl border shadow-sm space-y-4 flex flex-col justify-between transition-all duration-200 hover:-translate-y-1 ${
                    darkMode
                ...
                >
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <h3 className="font-extrabold text-lg sm:text-xl">{skill.name}</h3>
                      <span className={`text-sm font-mono font-black ${darkMode ? "text-emerald-400" : "text-sky-500"}`}>
                        {skill.level}%
                      </span>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                >
                    ...
                    <div className="flex items-start space-x-4">
                      <div
                        className={`p-3 rounded-xl border shrink-0 ${
                          darkMode ? "bg-slate-950 border-slate-800 text-emerald-400" : "bg-slate-50 border-slate-200 text-sky-600"
                        }`}
                      >
                  ...
                  <div className="pt-4 border-t border-slate-200 dark:border-slate-800/80 space-y-3">
                    ...
                    <div className="flex flex-wrap gap-3">
                      <a
                        href="https://web.facebook.com/zd.rich.1"
                        target="_blank"
                        rel="noreferrer"
                        aria-label="Facebook"
                        className={`p-3 rounded-xl border transition-all duration-300 hover:scale-105 active:scale-95 ${
                          darkMode
              ...
              <div className="lg:col-span-7">
                <form
                  ...
                  method="POST"
                  className={`p-6 sm:p-8 rounded-2xl border shadow-sm space-y-5 ${
                    darkMode ? "bg-slate-900/60 border-slate-800" : "bg-white border-slate-200"
                  }`}
                >
                  ...
                  <button
                    type="submit"
                    className={`w-full flex items-center justify-center space-x-2 p-4 rounded-xl font-bold text-sm text-white transition-all active:scale-95 shadow-lg ${
                      darkMode
                        ? "bg-emerald-500 hover:bg-emerald-600 shadow-emerald-500/20"
